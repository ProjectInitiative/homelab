...
__all__ = ['ApplicationSetInitArgs', 'ApplicationSet']

@pulumi.input_type
class ApplicationSetInitArgs:
...
@pulumi.type_token("kubernetes:argoproj.io/v1alpha1:ApplicationSet")
class ApplicationSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApplicationSet resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ApplicationSetInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ApplicationSet resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ApplicationSetInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApplicationSetInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApplicationSetInitArgs.__new__(ApplicationSetInitArgs)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ApplicationSet':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.ApplicationSetStatus']]:
