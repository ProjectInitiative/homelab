...
class ApplicationListArgs:
    def __init__(__self__, *,
                 items: pulumi.Input[Sequence[pulumi.Input['ApplicationArgs']]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApplicationArgs']]] items: List of applications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        ...
        if kind is not None:
            pulumi.set(__self__, "kind", 'ApplicationList')
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)

    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Sequence[pulumi.Input['ApplicationArgs']]]:
        """
    ...
    @items.setter
    def items(self, value: pulumi.Input[Sequence[pulumi.Input['ApplicationArgs']]]):
...
@pulumi.type_token("kubernetes:argoproj.io/v1alpha1:ApplicationList")
class ApplicationList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_version: Optional[pulumi.Input[_builtins.str]] = None,
                 items: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApplicationArgs', 'ApplicationArgsDict']]]]] = None,
                 kind: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] api_version: APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApplicationArgs', 'ApplicationArgsDict']]]] items: List of applications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        :param pulumi.Input[_builtins.str] kind: Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["kind"] = 'ApplicationList'
            __props__.__dict__["metadata"] = metadata
        super(ApplicationList, __self__).__init__(
            'kubernetes:argoproj.io/v1alpha1:ApplicationList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ApplicationList':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence['outputs.Application']]:
        """
        List of applications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
        """
        return pulumi.get(self, "items")
